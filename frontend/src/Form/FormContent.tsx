    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col xs:flex xs:flex-row justify-between gap-x-3 gap-y-5 sm:gap-x-3">
                <Field<string>
                    name="first_name"
                    title={props.errors && props.errors.first_name ? props.errors.first_name : ""}
                ...
                <Field<string>
                    name="last_name"
                    title={props.errors && props.errors.last_name ? props.errors.last_name : ""}
            ...
            <Field<string>
                name="username"
                title={props.errors && props.errors.username ? props.errors.username : ""}
                id="signup-username"
            ...
            <Field<string>
                name="password"
                title={props.errors && props.errors.password ? props.errors.password : ""}
                id="signup-password"
