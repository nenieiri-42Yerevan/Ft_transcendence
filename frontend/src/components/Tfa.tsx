...
const Tfa = (props)=>{
    return (
        <div className="w-full flex justify-center items-center mb-2">
            ...
            <div className="bg-[#201F1F] text-white rounded-md p-4 text-center w-full">{props.user.TFA_enabled ? "yor TFA secret is " + props.user.TFA_secret : "TFA is disabled"}</div>
        </div>
    );
}
